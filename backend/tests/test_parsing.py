...
class ParsingServiceTests(unittest.TestCase):
    ...
    def test_surfaces_unknown_lab_candidates_for_manual_review(self) -> None:
        spans = [
            ...
            SourceSpan(file_name="report.pdf", page=1, line_number=4, snippet="体重 123.4 kg 0-999"),
    ...
    def test_normalizes_body_metrics_and_cbc_differentials(self) -> None:
        ...
        samples = [
            ("体重 123.4 kg 0-999", "body_weight", "kg"),
            ...
            ("BMI 23.45 0-999", "bmi", "kg/m2"),
            ("收缩压 123.45 mmHg 0-999", "systolic_bp", "mmHg"),
            ("SBP 234.56 mmHg 0-999", "systolic_bp", "mmHg"),
            ("舒张压 12.34 0-999", "diastolic_bp", "mmHg"),
            ("DBP 23.45 mmHg 0-999", "diastolic_bp", "mmHg"),
            ("腰围 12.34 cm 0-999", "waist_circumference", "cm"),
            ("Waist 23.45 cm 0-999", "waist_circumference", "cm"),
            ("臀围 12.34 cm 0-999", "hip_circumference", "cm"),
            ("Hip 23.45 cm 0-999", "hip_circumference", "cm"),
            ("腰臀比 0.12 0-9", "waist_hip_ratio", "ratio"),
            ("WHR 0.23 0-9", "waist_hip_ratio", "ratio"),
            ("血小板 PLT 123.45 0-999", "platelet_count", "10^9/L"),
            ("PLT 234.56 10^9/L 0-999", "platelet_count", "10^9/L"),
            ("中性粒细胞 NEUT 12.34 0-999", "neutrophil_percentage", "%"),
            ("NEUT% 23.45 % 0-999", "neutrophil_percentage", "%"),
            ("淋巴细胞 LYM 12.34 0-999", "lymphocyte_percentage", "%"),
            ("LYM% 23.45 % 0-999", "lymphocyte_percentage", "%"),
            ("单核细胞 MONO 12.34 0-999", "monocyte_percentage", "%"),
            ("MONO% 23.45 % 0-999", "monocyte_percentage", "%"),
            ("嗜酸性粒细胞 EOS 12.34 0-999", "eosinophil_percentage", "%"),
            ("EOS% 23.45 % 0-999", "eosinophil_percentage", "%"),
            ("中性粒细胞绝对值 NEUT# 1.23 0-999", "neutrophil_absolute", "10^9/L"),
            ("NEUT# 2.34 10^9/L 0-999", "neutrophil_absolute", "10^9/L"),
            ("淋巴细胞绝对值 LYM# 1.23 0-999", "lymphocyte_absolute", "10^9/L"),
            ("LYM# 2.34 10^9/L 0-999", "lymphocyte_absolute", "10^9/L"),
            ("单核细胞数绝对值 MONO# 1.23 0-999", "monocyte_absolute", "10^9/L"),
            ("MONO# 2.34 10^9/L 0-999", "monocyte_absolute", "10^9/L"),
            ("嗜酸性粒细胞绝对值 EOS# 1.23 0-999", "eosinophil_absolute", "10^9/L"),
            ("EOS# 2.34 10^9/L 0-999", "eosinophil_absolute", "10^9/L"),
            ("平均血小板体积 MPV 12.34 fl 0-999", "mean_platelet_volume", "fL"),
            ("MPV 23.45 fL 0-999", "mean_platelet_volume", "fL"),
            ("血小板压积 PCT 12.34 0-999", "plateletcrit", "%"),
            ("PCT 23.45 % 0-999", "plateletcrit", "%"),
            ("估算肾小球滤过率 EGFR 12.34 mL/min 0-999", "egfr", "mL/min"),
            ("钙卫蛋白 Cal 12.34 ug/g 0-999", "fecal_calprotectin", "ug/g"),
        ]
        spans = [
