    ...
    <WorkflowShell
      ...
      headerActions={
        <>
          ...
          <button className="workflow-button workflow-button--secondary" type="button" disabled={busy} onClick={() => void logout()}><ArrowRightStartOnRectangleIcon className="workflow-button__icon" />退出 {doctor.display_name}</button>
        </>
      }
    >
          ...
          <div className="workflow-stack">
            ...
            <div className="workflow-action-row">
              ...
              <button className="workflow-button workflow-button--primary" type="button" disabled={busy} onClick={() => void handleDownloadReport()}>
                <DocumentArrowDownIcon className="workflow-button__icon" />
